...
<!--
    ...
    <tr>
        <td><label for="kary_id">Karyawan ID</label></td>
        <td><input name="kary_id" type="text" class="form-control" id="kary_id" placeholder="Karyawan ID" readonly/></td>
      </tr>
      <tr>
        <td><label for="kode_kar">Kode Karyawan</label></td>
        <td><input name="kode_kar" type="text" class="form-control" id="kode_kar" placeholder="Kode Karyawan" required/></td>
      </tr>
      <tr>
